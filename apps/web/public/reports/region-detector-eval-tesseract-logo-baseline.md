...
- recall_logo: 1.0
- bbox_match_rate: 1.0
- bbox_match_rate_text: 1.0
- bbox_match_rate_logo: 1.0

## Samples

| sample | scene | status | expected | detected | missed | false positive | sources | boxes | expected boxes | bbox IoU | bbox match | bbox miss |
|---|---|---|---|---|---|---|---|---|---|---|---|---|
| samples/cc0-product-label.jpg | marketing | evaluated | text;logo | text;logo |  |  | text:tesseract_ocr;logo:vision_detector | text:411,256,1262,1360;logo:103,80,569,330 | text:100,80,1045,1370;logo:103,80,1045,530 | text:0.39;logo:0.34 | text;logo |  |
...
| samples/commons-main-label.jpg | ecommerce | evaluated | text;logo | text;logo |  |  | text:tesseract_ocr;logo:logo_detector_baseline | text:184,168,1228,754;logo:605,328,392,415 | text:184,168,1228,754;logo:610,330,410,420 | text:1.00;logo:0.91 | text;logo |  |
| samples/commons-produk-packaging.jpg | ecommerce | evaluated | text;logo | text;logo |  |  | text:tesseract_ocr;logo:logo_detector_baseline | text:0,135,800,398;logo:401,309,116,75 | text:0,135,800,398;logo:420,285,150,75 | text:1.00;logo:0.33 | text;logo |  |
